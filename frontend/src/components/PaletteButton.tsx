...
interface PaletteButtonProps {
  icon: ComponentType<SVGProps<SVGSVGElement>> | string // может быть компонент или строка (путь к картинке)
  label: string
  type: string
  ring?: boolean
}

export default function PaletteButton({ icon, label, type, ring }: PaletteButtonProps) {
  ...
  />
          ...
          // @ts-ignore (для TypeScript, т.к. icon может быть компонентом)
